                                                        ...
                                                        {isAdmin && !isLeave && !isComplete ? (
                                                            <DropdownMenu>
                                                                ...
                                                                <DropdownMenuContent align="end" className="w-52 rounded-xl shadow-xl border-none p-2">
                                                                    ...
                                                                    {!hasIn && <DropdownMenuItem className="rounded-xl py-2.5 px-3 font-bold text-xs" onClick={() => handleAlpaConversionToAttendance(item, 'terlambat')}>Set Terlambat</DropdownMenuItem>}
