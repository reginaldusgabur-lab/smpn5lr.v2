...
export default function SchoolReportPage() {
    ...
    const loadData = useCallback(async () => {
        ...
        try {
            ...
            // FIXED: Corrected the ReferenceError by passing the query variables instead of the snap variables.
    ...
    const handleDownloadPdf = async () => {
        ...
        try {
            ...
            autoTable(doc, {
                ...
                columnStyles: { 0: { halign: 'center', cellWidth: 8 }, 1: { halign: 'left', cellWidth: 'auto' }, 2: { halign: 'left', cellWidth: 38 }, 3: { halign: 'center', cellWidth: 18 }, 4: { halign: 'center', cellWidth: 15 }, 5: { halign: 'center', cellWidth: 12 }, 6: { halign: 'center', cellWidth: 15 }, 7: { halign: 'center', cellWidth: 12 }, 8: { halign: 'right', cellWidth: 13 } }
            });
