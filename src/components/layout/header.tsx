          ...
          <div className="bg-primary/5 p-8 border-b border-muted-foreground/10 flex flex-col items-center text-center">
            <DialogHeader>
              <div className="space-y-1">
                <DialogTitle className="text-2xl font-bold tracking-tight text-primary text-center w-full">Panduan & FAQ E-SPENLI</DialogTitle>
                <DialogDescription className="font-bold text-xs text-muted-foreground uppercase tracking-widest text-center w-full">
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1" className="border-none mb-2">
                <AccordionTrigger className="hover:no-underline p-4 bg-muted/30 rounded-2xl transition-all data-[state=open]:rounded-b-none data-[state=open]:bg-primary/5">
                  <span className="font-bold text-sm text-center w-full">Apa kegunaan aplikasi E-SPENLI?</span>
                </AccordionTrigger>
              ...
              <AccordionItem value="item-7" className="border-none mb-2">
                <AccordionTrigger className="hover:no-underline p-4 bg-muted/30 rounded-2xl transition-all data-[state=open]:rounded-b-none data-[state=open]:bg-primary/5">
                  <span className="font-bold text-sm text-center w-full">Fungsi Indikator Sinyal?</span>
                </AccordionTrigger>
              ...
              <AccordionItem value="item-8" className="border-none mb-2">
                <AccordionTrigger className="hover:no-underline p-4 bg-muted/30 rounded-2xl transition-all data-[state=open]:rounded-b-none data-[state=open]:bg-primary/5">
                  <span className="font-bold text-sm text-center w-full">Fungsi Ikon Tema (Matahari/Bulan)?</span>
                </AccordionTrigger>
                <AccordionContent className="p-4 bg-primary/5 rounded-b-2xl text-xs font-medium leading-relaxed text-muted-foreground">
              ...
              <AccordionItem value="item-9" className="border-none mb-2">
                <AccordionTrigger className="hover:no-underline p-4 bg-muted/30 rounded-2xl transition-all data-[state=open]:rounded-b-none data-[state=open]:bg-primary/5">
                  <span className="font-bold text-sm text-center w-full">Cara Ganti Foto Profil?</span>
                </AccordionTrigger>
              ...
              <AccordionItem value="item-2" className="border-none mb-2">
                <AccordionTrigger className="hover:no-underline p-4 bg-muted/30 rounded-2xl transition-all data-[state=open]:rounded-b-none data-[state=open]:bg-primary/5">
                  <span className="font-bold text-sm text-center w-full">Masalah izin kamera (Camera blocked)?</span>
                </AccordionTrigger>
              ...
              <AccordionItem value="item-3" className="border-none mb-2">
                <AccordionTrigger className="hover:no-underline p-4 bg-muted/30 rounded-2xl transition-all data-[state=open]:rounded-b-none data-[state=open]:bg-primary/5">
                  <span className="font-bold text-sm text-center w-full">Kendala batas waktu absensi?</span>
                </AccordionTrigger>
                <AccordionContent className="p-4 bg-primary/5 rounded-b-2xl text-xs font-medium leading-relaxed text-muted-foreground">
              ...
              <AccordionItem value="item-4" className="border-none mb-2">
                <AccordionTrigger className="hover:no-underline p-4 bg-muted/30 rounded-2xl transition-all data-[state=open]:rounded-b-none data-[state=open]:bg-primary/5">
                  <span className="font-bold text-sm text-center w-full">Gagal absen karena masalah lokasi?</span>
                </AccordionTrigger>
                <AccordionContent className="p-4 bg-primary/5 rounded-b-2xl text-xs font-medium leading-relaxed text-muted-foreground">
              ...
              <AccordionItem value="item-6" className="border-none mb-2">
                <AccordionTrigger className="hover:no-underline p-4 bg-muted/30 rounded-2xl transition-all data-[state=open]:rounded-b-none data-[state=open]:bg-primary/5">
                  <span className="font-bold text-sm text-center w-full">Lupa kata sandi?</span>
                </AccordionTrigger>
                <AccordionContent className="p-4 bg-primary/5 rounded-b-2xl text-xs font-medium leading-relaxed text-muted-foreground">
